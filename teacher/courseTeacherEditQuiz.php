		...
		<div class='col col-md-10' style='padding-left:50px'> 
			<div class="panel panel-primary">
			  ...
			  <div class="panel-heading assignment_heading">
			  	<span class='glyphicon glyphicon-file'></span> Edit Quiz
			  </div>
			  <div class="panel-body">
			  		<div class="col-md-11">
			    		...
			    		<div class="input-group">
						      ...
						      <input type="text" class="form-control" value="Quiz Subtitle">
			    		</div>
			    		<br>
			    		<div class="row">
			    			<div class="col-md-6">
			    		...
			    		<div class="form-group">
	    					...
	    					<!-- <textarea class="form-control" id="exampleFormControlTextarea1" rows="7"> -->
	    						<ol type='1'>
									<li><input type='text' class="form-control" value="Lorem Ipsum Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo?" /></li>
									<li><input type='text' class="form-control" value="Lorem Ipsum Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore verita? Why?" /></li>
									<li><input type='text' class="form-control" value="Lorem Ipsum Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritaLorem Ipsum Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo?" /> </li>
								</ol>
	    					<!-- </textarea> -->
  						</div>
